  ...
  <div class="login-box">
    <div v-if="!logined">
      ...
      <div class="login-form">
        ...
        <at-input v-model="loginForm.auth" placeholder="请输入验证码" append-button size='large' @blur="verify()">
          <template slot="append">
            <at-button v-show="!isGetting" type="primary" size='small' @click="getAuth">点击获取验证码</at-button>
            <at-button class="disabeldbtn" v-show="isGetting" type="primary" size='small' @click="getAuth" disabled>
              {{count}}s后重新获取</at-button>
          </template>
        </at-input>
        ...
        <at-input v-model="loginForm.password" type="password" placeholder="请输入密码" size='large'
          @blur="validPass(loginForm.password)">
          <template slot="prepend">
...
export default {
  ...
  computed: {
    ...mapGetters({ avater: 'getAvater', nickname: 'getNickName', logined: 'getToken' }),
  },
