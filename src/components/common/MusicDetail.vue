<template>
  <div class="detail-box">
    ...
    <div class="detail-table">
      <el-table :row-style="getRowClass" :cell-style="getRowClass" :header-row-style="getHeaderClass"
        :header-cell-style="getHeaderClass" :data="musicInfo" style="width: 100%">
        <el-table-column type="index" width="80">
        </el-table-column>
        <el-table-column prop="musicIdList" label="操作" width="120">
        ...
        <el-table-column prop="musicNameList" label="音乐标题" width="285">
        </el-table-column>
        <el-table-column prop="musicArtList" label="歌手" width="277">
        </el-table-column>
        <el-table-column prop="musivAlbumList" label="专辑" width="270">
        </el-table-column>
        <el-table-column prop="musicDurationList" label="时长" width="270">
        </el-table-column>
      </el-table>
    </div>
  </div>
...
export default {
  ...
  async created () {
    ...
    this.musicInfo = formatTabel([musicIdList, musicNameList, musivAlbumList, musicArtList, musicDurationList])
